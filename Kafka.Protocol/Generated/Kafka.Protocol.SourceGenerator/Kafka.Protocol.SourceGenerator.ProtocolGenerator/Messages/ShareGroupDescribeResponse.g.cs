    ...
    public class ShareGroupDescribeResponse : Message
    {
        ...
        public class DescribedGroup : ISerialize
        {
            ...
            public class Member : ISerialize
            {
                ...
                int ISerialize.GetSize(bool asCompact) => GetSize(asCompact);
                internal int GetSize(bool _) => _memberId.GetSize(IsFlexibleVersion) + _rackId.GetSize(IsFlexibleVersion) + _memberEpoch.GetSize(IsFlexibleVersion) + _clientId.GetSize(IsFlexibleVersion) + _clientHost.GetSize(IsFlexibleVersion) + _subscribedTopicNamesCollection.GetSize(IsFlexibleVersion) + _assignment.GetSize(IsFlexibleVersion) + (IsFlexibleVersion ? CreateTagSection().GetSize() : 0);
