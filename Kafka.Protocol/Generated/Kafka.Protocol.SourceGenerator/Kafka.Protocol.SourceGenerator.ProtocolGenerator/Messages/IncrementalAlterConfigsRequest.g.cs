    ...
    public class IncrementalAlterConfigsRequest : Message, IRespond<IncrementalAlterConfigsResponse>
    {
        ...
        public class AlterConfigsResource : ISerialize
        {
            ...
            public class AlterableConfig : ISerialize
            {
                ...
                int ISerialize.GetSize(bool asCompact) => GetSize(asCompact);
                internal int GetSize(bool _) => _name.GetSize(IsFlexibleVersion) + _configOperation.GetSize(IsFlexibleVersion) + _value.GetSize(IsFlexibleVersion) + (IsFlexibleVersion ? CreateTagSection().GetSize() : 0);
        ...
        public IncrementalAlterConfigsResponse Respond() => new IncrementalAlterConfigsResponse(Version);
    }
}
